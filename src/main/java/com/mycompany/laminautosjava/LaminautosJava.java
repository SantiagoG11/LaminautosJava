                    ...
                    if (opcion5 == 1) {
                        ...
                        if (vendedor_encontrado != null) {
                            ...
                            if (vehiculoN_encontrado != null) {
                                double venta = vehiculoN_encontrado.calcularValorVenta();
                                System.out.println("----------------------------------------");
                                System.out.println("+ Vehiculo " + vehiculoN_encontrado.getMarca() + " identificado con " + vehiculoN_encontrado.getIdNuevo());
                        ...
                        System.out.println("- Venta vehiculo usado -");
                        System.out.print("Identificador vendedor: ");
                        int id_ven = Integer.parseInt(scanner.nextLine());
                        ...
                        if (vendedor_encontrado != null) {
                            ...
                            if (vehiculoU_encontrado != null) {
                                double venta = vehiculoU_encontrado.calcularValorVenta();
                                System.out.println("----------------------------------------");
                                System.out.println("+ Vehiculo " + vehiculoU_encontrado.getMarca() + " identificado con " + vehiculoU_encontrado.getIdUsado());
                                System.out.println("Valor de venta: $" + venta + "\n");
                    ...
                    if (opcion6 == 1) {
                        ...
                        if (cliente_encontrado != null) {
                            for (Vehiculo vehiculo : vehiculos) {
                                if (vehiculo instanceof Vehiculo && vehiculo.getIdVehiculo() == id_veh) {
